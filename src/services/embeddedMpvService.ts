...
const HIGH_QUALITY_PROFILE: Record<string, string> = {
  ...
  // 'hable' preserves both dark and bright detail in HDR→SDR conversion.
  "tone-mapping": "hable",
  // Dynamic per-scene peak detection for best HDR tone-mapping accuracy.
  "hdr-compute-peak": "auto",
  // Allow moderate brightness boost in dark scenes to reveal shadow detail.
  // Default 1.0; 3.0 lifts shadows well without washing out highlights.
  ...
  // Static values look good on some content but break others.
  // Leaving them at the default (0) lets MPV reproduce the source faithfully.
};
